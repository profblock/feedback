...
static long int WHISPER_UNITS_IN_A_METER = 100000;
...
static long int WHISPER_TICS_PER_SECOND = 100;
...
static double WHISPER_ALPHA = 3; //Times (d+1), then squared
static double WHISPER_BETA = 2;  // Multiplied by above value



/***** Whisper Room Dimensions *****/
static long int WHISPER_ROOM_SIDE = 2000000;
static long int WHISPER_SPEAKER_RADIUS = 800000;


/*set to 0 if there is no occluding object, 1 if there is */
static int OCCLUDING_OBJECT = 1;
static int OCCLUDING_OBJECT_SIZE = 250;

/***** EXPERIMENT SETUP ******/
// These are not Constant because they might be changeable by the initWhisper method.
static int NUMBER_OF_SPEAKERS = 8;
static int NUMBER_OF_MICROPHONES = 4;
static double SPEAKER_SPEED_IN_M_PER_SEC = 0.02;
...
static noiseStruct* NOISE_LIST= 0;
static noiseStruct* END_LIST = 0;
